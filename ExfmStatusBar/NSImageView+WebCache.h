...
@interface NSImageView (WebCache) <SDWebImageManagerDelegate>
 ...
 */
- (void)setImageWithURL:(NSURL *)url placeholderImage:(NSImage *)placeholder;
 ...
 */
- (void)setImageWithURL:(NSURL *)url placeholderImage:(NSImage *)placeholder options:(SDWebImageOptions)options;
